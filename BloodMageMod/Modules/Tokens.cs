...
namespace BloodMageMod.Modules
{
    internal static class Tokens
    {
        ...
        internal static void AddTokens()
        {
            ...
            LanguageAPI.Add(prefix + "PRIMARY_BLOODBOLT_DESC", Helpers.sanguinePrefix + "<style=cIsUtility>Sanguine.</style> <style=cIsHealth>15 HP/s.</style> Drain your health to charge a blood bolt, which <style=cIsUtility>pierces all enemies</style> and deals <style=cIsDamage>200% damage</style>.");
            ...
            LanguageAPI.Add(prefix + "UTILITY_PETRIBLOOD_DESC", "<style=cIsHealth>Sets your HP to 50%, and prevents you from recovering above 50% HP. </style>"
                + "<style=cIsDamage>40% of damage from hits</style> is taken instantly, and the other <style=cIsDamage>60%</style> is taken over <style=cIsUtility>4 seconds</style>.");
            ...
            LanguageAPI.Add(prefix + "SPECIAL_DOOMDESIRE_DESC", "Place a debuff on both you and the target. The debuff on you causes you to take "
                ...
                + "When the debuff expires, it deals <style=cIsDamage>1000% of the stored damage in an explosion</style>." + Environment.NewLine
